...
CliOptions.start = function(DataManager) {
  ...
  program.on("--help", function() {
    console.log("");
    console.log("  Usage: paswitch [options] [command]");
    console.log("");
    console.log("  Options:");
    console.log("");
    console.log("    -d, --default                         Sets the target sink as the default sink (defaults to this without -d or -m flags)");
    console.log("    -m, --mute                            Sets all memorized sinks except the target as muted");
    console.log("    -V, --version                         output the version number");
    console.log("    -h, --help                            output usage information");
    console.log("");
    console.log("  Commands:");
    console.log("");
    console.log("    switch <friendly-name>                Switches to the specific sink");
    console.log("    toggle                                Switches to the next sink in the list");
    console.log("    set-sink <friendly-name> <sink-name>  Adds or replaces a sink");
    console.log("    remove-sink <friendly-name>           Removes (forgets) a sink");
    console.log("    wizard <type>                         Starts a wizard");
    console.log("    list                                  Lists all memorized sinks");
    console.log("    notify <value>                        Enable or disable notify, value should be 'enable' or 'disable'");
    console.log("");
